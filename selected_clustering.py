...
def main():
    parser = argparse.ArgumentParser(description="Run Leiden clustering on selected exact/best/worst kNN graphs")
    ...
    parser.add_argument("--partition_type", choices=["RBConfiguration", "CPM", "Modularity"], default="RBConfiguration")
    ...
    for _, row in manifest.iterrows():
        ...
        labels = cluster_leiden(adata, args.flavor, args.partition_type, args.resolution, args.random_seed)
